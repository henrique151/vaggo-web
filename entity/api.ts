...
export default class API {
    ...
    async call(uri:string, useToken:boolean, params?:IcallParams) : Promise<ApiResponse | DataResponse | Response | undefined>
    async call(uri:string, useToken:boolean = true, params?:IcallParams) : Promise<ApiResponse | DataResponse | Response | undefined>
    {
        console.log(`params: -URI:${uri}, -Token?:${useToken}, Params:${JSON.stringify(params)}, content-type: ${params?.contentType}`)
        ...
        const res = await fetch(`${this.API_ADDRESS}${uri}`, {headers: requestHeader, body: requestBody, method:requestMethod})
