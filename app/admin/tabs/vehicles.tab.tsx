...
const sizeLabel = { PEQUENO: "Pequeno", MEDIO: "Médio", GRANDE: "Grande" } as const;

const Page = () => {
  // TODO: const { vehicles } = useAdminContext();
  const vehicles: AdminVehicle[] = []; // placeholder
          ...
          vehicles.map((vehicle) => (
            ...
            >
              <DefaultEntityFrame
                ...
                description={`Dono: ${vehicle.ownerName}`}
                tagList={[
